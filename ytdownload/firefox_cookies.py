# download_comments4.py
# claude.ai
# download youtube comments only
# with progress logger that shows:
# and cookie support for age restricted videos
...
def download_comments(url: str) -> str:
    ...
    try:
        ...
        print("2. You are logged into YouTube in Firefox")
        print("3. Firefox is closed (if yt-dlp can't access the profile)")
        return None
